...
import { getRootURL, getS3GIFUrl, prefixURL } from '../../../utils/url';
...
class GifSection extends React.PureComponent {
  ...
  constructor(props) {
    ...
    const staffPickForThisCity = GifData.staffPicks.filter(
      (staffPick) => staffPick.citySlug === this.props.city.slug
    );
  ...
  getShareUrl(staffPickData) {
    return `https://${getRootURL()}/${staffPickData.citySlug}/explore/car/lanes/${
      staffPickData.id
    }`;
  }
    ...
    return (
      <div className="GifSection">
        <div className="Wrapper">
          <h2 className="Title">Street sausage gif gallery</h2>
          {this.state.staffPickForThisCity && this.state.staffPickForThisCity.length >= 5 && (
            <div className="CitySection">
              <h4 className="SubTitle">{this.props.city.name}</h4>
          ...
          <div className="OtherCitySection">
            <h4 className="SubTitle">Across the world</h4>
          ...
          <div className="OtherCitySection">
            <h4 className="SubTitle">Create your own gif</h4>
